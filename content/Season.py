...
schema = Schema((
    ...
    DateTimeField(
        ...
        widget=DateTimeField._properties['widget'](
            ...
            description_msgid='PloneShows_help_donorRenewalStartDate',
    ...
    DateTimeField(
        ...
        widget=DateTimeField._properties['widget'](
            ...
            label_msgid='PloneShows_label_donorRenewalEndDate',
            description_msgid='PloneShows_help_donorRenewalEndDate',
            i18n_domain='PloneShows',
        ),
    ),
    DateTimeField(
        ...
        widget=DateTimeField._properties['widget'](
            ...
            description_msgid='PloneShows_help_seasonRenewalStartDate',
            i18n_domain='PloneShows',
        ),
    ),
    DateTimeField(
        ...
        widget=DateTimeField._properties['widget'](
            ...
            label_msgid='PloneShows_label_seasonRenewalEndDate',
            description_msgid='PloneShows_help_seasonRenewalEndDate',
            i18n_domain='PloneShows',
        ),
    ),
    DateTimeField(
        ...
        widget=DateTimeField._properties['widget'](
            ...
            description_msgid='PloneShows_help_seasonNewStartDate',
            i18n_domain='PloneShows',
        ),
    ),
    DateTimeField(
        ...
        widget=DateTimeField._properties['widget'](
            ...
            label_msgid='PloneShows_label_seasonNewEndDate',
            description_msgid='PloneShows_help_seasonNewEndDate',
            i18n_domain='PloneShows',
        ),
    ),
    DateTimeField(
    ...
    ImageField(
        ...
        widget=ImageField._properties['widget'](
            ...
            description_msgid='PloneShows_help_donorRenewalImage',
            i18n_domain='PloneShows',
        ),
    ...
    ImageField(
        ...
        widget=ImageField._properties['widget'](
            ...
            description_msgid='PloneShows_help_seasonRenewalImage',
            i18n_domain='PloneShows',
        ),
        storage=AttributeStorage(),
        max_size=(220,220),
    ...
    ImageField(
        ...
        widget=ImageField._properties['widget'](
            ...
            description_msgid='PloneShows_help_seasonNewImage',
            i18n_domain='PloneShows',
        ),
        storage=AttributeStorage(),
        max_size=(220,220),
    ...
    ImageField(
        ...
        widget=ImageField._properties['widget'](
            ...
            description_msgid='PloneShows_help_individualTixImage',
            i18n_domain='PloneShows',
        ),
        storage=AttributeStorage(),
        max_size=(220,220),
    ...
    StringField(
        ...
        widget=StringField._properties['widget'](
            ...
            description_msgid='PloneShows_help_donorRenewalLinkText',
            i18n_domain='PloneShows',
        ),
    ),
    StringField(
        ...
        widget=StringField._properties['widget'](
            ...
            description_msgid='PloneShows_help_seasonRenewalLinkText',
            i18n_domain='PloneShows',
        ),
    ),
    StringField(
        ...
        widget=StringField._properties['widget'](
            ...
            description_msgid='PloneShows_help_seasonNewLinkText',
            i18n_domain='PloneShows',
        ),
    ),
    StringField(
        ...
        widget=StringField._properties['widget'](
            ...
            description_msgid='PloneShows_help_individualTixLinkText',
            i18n_domain='PloneShows',
        ),
    ),
    StringField(
        ...
        widget=StringField._properties['widget'](
            ...
            description_msgid='PloneShows_help_donorRenewalLink',
            i18n_domain='PloneShows',
        ),
    ),
    StringField(
        ...
        widget=StringField._properties['widget'](
            ...
            description_msgid='PloneShows_help_seasonRenewalLink',
            i18n_domain='PloneShows',
        ),
    ),
    StringField(
